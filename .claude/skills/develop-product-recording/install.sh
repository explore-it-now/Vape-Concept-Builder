#!/bin/bash
# Installs the develop-product-recording skill for every Claude Code session on this computer (macOS / Linux).
set -e
SRC="$(cd "$(dirname "$0")" && pwd)"
DEST="$HOME/.claude/skills/develop-product-recording"
...
echo "Then open Claude Code on this computer and say: develop product recording"
