# develop-product-recording (Claude Code skill)
...
./Vape-Concept-Builder/.claude/skills/develop-product-recording/install.sh
```
Windows (PowerShell):
```
git clone https://github.com/explore-it-now/Vape-Concept-Builder.git
powershell -ExecutionPolicy Bypass -File .\Vape-Concept-Builder\.claude\skills\develop-product-recording\install.ps1
```
...
2. Say **"develop product recording"** (or `/develop-product-recording`).
